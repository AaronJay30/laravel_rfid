...
<div class="min-h-screen flex items-center justify-center">
  <div class="card p-10 sm:p-14 mx-8 sm:mx-0 bg-black border-4 shadow-xl bg-opacity-30 rounded-2xl" style="border-color: #BC6C25">
    <div class="card-body">
      <h1 class="card-title text-white text-3xl font-bold pb-3">Hello! Welcome back</h1>
      <p class="text-white text-sm pb-6">Track and monitor your livestock seamlessly with our RFID-based system.</p>
      ...
      <form action="{{route('login.process')}}" method="POST">
        ...
        <!-- Password Input -->
        <div class="mb-1">
          <label for="password" class="block mb-2 mt-3 text-md font-medium text-white">Password</label>
        ...
        <div class="mb-3 flex-col sm:flex sm:flex-row gap-14 sm:gap-0 items-center justify-between py-2">
          <div class="sm:pb-0 pb-3">
            <input type="checkbox" name="remember" class=" bg-white border-white text-green-500 focus:ring-0 duration-200" id="rememberMe">
            <label class="form-check-label text-white" for="rememberMe">Remember me</label>
          </div>
          <a href="{{route('forgot.password')}}" class="text-white text-decoration-none hover:text-green-300 duration-200">Forgot password?</a>
        </div>

        <button type="submit" class="btn block mb-6 p-2 rounded-md bg-white w-full hover:bg-green-600 duration-200" style="color: #344403">Login</button>
      </form>
      ...
      <h2 class="text-center text-white text-lg hover:text-green-300 duration-200"><a href="{{route('register')}}">Doesn't have an account?</a></h2> --}}
